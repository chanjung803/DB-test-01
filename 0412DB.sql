...
SELECT * FROM 고객 GROUP BY 등급;

SELECT * FROM 고객 WHERE 등급 = 'gold';

SELECT * FROM 고객 ORDER BY 고객아이디 ASC;

SELECT 고객아이디, 고객이름, 등급 FROM 고객;

SELECT 고객아이디, 고객이름, 등급 FROM 배송업체;

SELECT 고객아이디, 고객이름 FROM 배송업체;

SELECT 고객아이디 FROM 배송업체;

SELECT 업체이름 FROM 배송업체;

SELECT 업체명 
    FROM 배송업체;

SELECT 업체명 FROM 배송업체;

SELECT 고객아이디, 고객이름, 등급 FROM 고객;

SELECT 고객아이디, 고객이름, 등급 FROM 고객;

SELECT 고객아이디, 고객이름, 등급, 직업, 적릭금 FROM 고객;

SELECT 고객아이디, 고객이름, 등급 FROM 고객;

SELECT 고객아이디, 고객이름, 등급, 직업, 적립금 FROM 고객;
